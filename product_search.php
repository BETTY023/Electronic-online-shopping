...
<?php
if($search_keyword!='')
    $search_con="and (p.product_name LIKE '%$search_keyword%' || pc.product_cat_name LIKE '%$search_keyword%')";
  else
    $search_con='';

          if($search_cat!=0)
            $search_cat_id="and pc.id='$search_cat'";
          else
            $search_cat_id='';

            $query="select pc.product_cat_name,pc.id as cat_id,p.id as pro_id,p.product_price,p.product_cat_id,p.product_discount,p.product_name,p.product_image_name1 from inv_products p inner join inv_product_categories pc on pc.id = p.product_cat_id where  pc.product_cat_status='1' $search_cat_id $search_con order by pc.id desc";
          ...
          { ?>
                  <div class="col-md-4 product" style="padding: 60px">
                      <div class="product-img" style="text-align: center;">
                        <img style="width:unset !important;height: 180px !important;"  src="upload_folder/product/<?php echo $row['pro_id'];?>/<?php echo $row['product_image_name1'];?>" alt="">
                      ...
                      <div class="product-body">
                        ...
                        <h4 class="product-price"><?php echo (($row['product_price'])-($row['product_price']/$row['product_discount'])) ?> <del class="product-old-price"><?php echo $row['product_price']; ?></del></h4>
